package io.sample.demo.qa.locators;
...
public class Locators implements ILocators<Locator> {
    ...
    public Locator getPageLocator(String webLocator) {
        Objects.requireNonNull(webLocator, "Web Locator cannot be null!");
        return webLocator.startsWith("//") || webLocator.startsWith("(")
                ? PAGE.locator("xpath=" + webLocator)
                : PAGE.locator(webLocator); // CSS assumed
    }
