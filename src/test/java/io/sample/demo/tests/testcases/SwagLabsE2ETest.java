package io.sample.demo.tests.testcases;

import io.sample.demo.tests.dataprovider.SwagLabsDataProvider;
import io.sample.demo.tests.constants.TestGroups;
...
public final class SwagLabsE2ETest extends SwagLabsTestBase {
    ...
    @Test(description = "User Journey: To complete the purchase of one product.", dataProvider = "purchase-one-product",
            dataProviderClass = SwagLabsDataProvider.class, groups = {TestGroups.SWAG_LABS_TEST})
