...
import io.sample.demo.tests.commons.WebBaseTest;
import io.sample.demo.qa.exceptions.WebPageException;
import io.sample.demo.qa.module.SwagLabsPortal;
...
@Slf4j
public sealed class SwagLabsTestBase extends WebBaseTest permits SwagLabsE2ETest {
